    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="flex gap-3">
          ...
          <Button
            variant="outline"
            className={`h-12 w-12 shrink-0 rounded-none border-border p-0 relative ${getItemQuantity(product.id) > 0 ? "bg-foreground text-background hover:bg-foreground/90" : ""}`}
          ...
          >
            ...
            {getItemQuantity(product.id) > 0 && (
              <span className="absolute -top-1.5 -right-1.5 w-5 h-5 bg-foreground text-background text-[0.65rem] font-semibold rounded-full flex items-center justify-center border-2 border-background">
